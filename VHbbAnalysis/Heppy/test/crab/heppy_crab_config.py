...
config.General.requestName = 'vhbb_heppy_blike_final_v13'
config.General.workArea = 'crab_projects_blike_final_v13'
...
config.JobType.inputFiles = ['heppy_config.py',
                             ...
                             'puMC.root',
                              ...
                              "../VBF-spring15.weights.xml",
										'../TMVA_blikelihood_vbf_singlebtag_v13.xml'
]
...
config.Data.outLFNDirBase = '/store/user/nchernya/vhbb_final_v13/'
