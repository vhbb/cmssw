...
trigemu = cfg.Analyzer(
    ...
    slEleSelection = lambda x : x.pt() > 25 and x.mvaIDRun2("GenSpring16","POG90") and ele_mvaEleID_Trig_preselection(x),
    ...
    dlEleSelection = lambda x : x.pt() > 15 and x.mvaIDRun2("GenSpring16","POG80") and ele_mvaEleID_Trig_preselection(x),
...
VHbb = cfg.Analyzer(
    ...
    wEleSelection = lambda x : x.pt() > 25 and x.mvaIDRun2("GenSpring16","POG90") and ele_mvaEleID_Trig_preselection(x),
    ...
    zEleSelection = lambda x : x.pt() > 15 and x.mvaIDRun2("GenSpring16","POG80") and ele_mvaEleID_Trig_preselection(x),
