...
VHbb = cfg.Analyzer(
    ...
    wEleSelection = lambda x : x.pt() > 25 and ((x.electronID("mvaEleID-Spring15-25ns-Trig-V1-wp80") and ele_mvaEleID_Trig_preselection(x)) or x.electronID("cutBasedElectronID-Spring15-25ns-V1-standalone-tight")),
