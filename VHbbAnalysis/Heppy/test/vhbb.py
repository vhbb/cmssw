	...
	vectorTree = True,
        globalVariables	= [
		 ...
		 NTupleVariable("lheV_pt",  lambda ev: ev.lheV_pt, float,mcOnly=True, help="Vector pT at LHE level"),
                 ...
                 NTupleVariable("genH_decayMode", lambda ev: ev.genH_decayMode, int,mcOnly=True, help="gen level Higgs decay mode (product of pdgIds of the two daughter particles)"),
...
sequence = [LHEAna,FlagsAna, GenAna,VHGenAna,PUAna,TrigAna,VertexAna,LepAna,PhoAna,TauAna,JetAna,ttHLeptonMVA,METAna,PdfAna,VHbb,TTHtoTauTau,TTHtoTauTauGen,treeProducer]#,sh]
