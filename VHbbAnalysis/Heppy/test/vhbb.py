...
#Need to define global objects here to add shifted MET
globalObjects = {
...
globalObjects.update(shifted_mets)
...
treeProducer= cfg.Analyzer(
	...
	vectorTree = True,
     ...
     NTupleVariable("pdf_x1",  lambda ev: ev.pdf_x1, float,mcOnly=True, help="FIXME"),
     NTupleVariable("pdf_x2",  lambda ev: ev.pdf_x2, float,mcOnly=True, help="FIXME"),
     NTupleVariable("pdf_id1",  lambda ev: ev.pdf_id1, int,mcOnly=True, help="FIXME"),
     NTupleVariable("pdf_id2",  lambda ev: ev.pdf_id2, int,mcOnly=True, help="FIXME"),
     NTupleVariable("pdf_scale",  lambda ev: ev.pdf_scale, float,mcOnly=True, help="FIXME"),
...
PdfAna = PDFWeightsAnalyzer.defaultConfig
