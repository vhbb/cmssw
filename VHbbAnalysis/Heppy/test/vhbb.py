...
VHbb = cfg.Analyzer(
    ...
    wEleSelection = lambda x : x.pt() > 25 and (( getattr(x,"mvaIdSpring15TrigTight",False) and ele_mvaEleID_Trig_preselection(x)) or x.electronID("cutBasedElectronID-Spring15-25ns-V1-standalone-tight")),
