...
sequence = [LHEAna,FlagsAna, GenAna,VHGenAna,TrigAna,VertexAna,LepAna,TauAna,PhoAna,JetAna,METAna,VHbb,treeProducer]
...
if __name__ == '__main__':
    ...
    looper = Looper( 'Loop', config, nPrint = 5, nEvents = 600)
    import time
    import cProfile
