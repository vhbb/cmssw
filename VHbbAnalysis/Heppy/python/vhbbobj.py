...
#see below
    ...
    NTupleVariable("btagDeepCSVc",   lambda x : x.bDiscriminator("deepFlavourJetTags:probc"), help="deepCSV  charm"),
    NTupleVariable("btagDeepCSVbb",   lambda x : x.bDiscriminator("deepFlavourJetTags:probbb"), help="deepCSV  bb"),
    NTupleVariable("btagDeepCMVAdusg",   lambda x : x.bDiscriminator("deepFlavourCMVAJetTags:probudsg"), help="deepCMVA dusg"),
    NTupleVariable("btagDeepCMVAb",   lambda x : x.bDiscriminator("deepFlavourCMVAJetTags:probb"), help="deepCMVA b"),
    NTupleVariable("btagDeepCMVAc",   lambda x : x.bDiscriminator("deepFlavourCMVAJetTags:probc"), help="deepCMVA  charm"),
    NTupleVariable("btagDeepCMVAbb",   lambda x : x.bDiscriminator("deepFlavourCMVAJetTags:probbb"), help="deepCMVA  bb"),
