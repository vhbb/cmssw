...
jetTypeVHbb = NTupleObjectType("jet",  baseObjectTypes = [ jetType ], variables = [
    ...
    NTupleVariable("btagProb", lambda x : x.btag('pfJetProbabilityBJetTags') , help="btag"),
    NTupleVariable("btagBProb", lambda x : x.btag('pfJetBProbabilityBJetTags') , help="btag"),
    ...
    NTupleVariable("btagCSVV0",   lambda x : x.bDiscriminator('pfCombinedSecondaryVertexV2BJetTags'), help="should be the old CSV discriminator"),
   # NTupleVariable("mcMatchId",    lambda x : x.mcMatchId,   int, mcOnly=True, help="Match to source from hard scatter (25 for H, 6 for t, 23/24 for W/Z)"),
...
# this only read qgl if it was explicitelly computed in the code
    ...
    NTupleVariable("cut_debug",lambda x : getattr(x,"cut_debug",-2), help="VBF blikelihood debug"),
    NTupleVariable("VBFetaIdx",lambda x : getattr(x,"VBFetaIdx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBFbtagIdx",lambda x : getattr(x,"VBFbtagIdx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBFptIdx",lambda x : getattr(x,"VBFptIdx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBFeta",lambda x : getattr(x,"VBFeta",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBFbtag",lambda x : getattr(x,"VBFbtag",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBFpt",lambda x : getattr(x,"VBFpt",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_phi1",lambda x : getattr(x,"VBF_phi1",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_phi2",lambda x : getattr(x,"VBF_phi2",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_q1Idx",lambda x : getattr(x,"VBF_q1Idx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_q2Idx",lambda x : getattr(x,"VBF_q2Idx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_btagMax",lambda x : getattr(x,"VBF_btagMax",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_btagMaxIdx",lambda x : getattr(x,"VBF_btagMaxIdx",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_loopJet",lambda x : getattr(x,"VBF_loopJet",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_JetMaxlen",lambda x : getattr(x,"VBF_JetMaxlen",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_nJet",lambda x : getattr(x,"VBF_nJet",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_4btagLen",lambda x : getattr(x,"VBF_4btagLen",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_4Len0",lambda x : getattr(x,"VBF_4Len0",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_4Len1",lambda x : getattr(x,"VBF_4Len1",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_4Len2",lambda x : getattr(x,"VBF_4Len2",-11), help="VBF blikelihood debug"),
    NTupleVariable("VBF_4Len3",lambda x : getattr(x,"VBF_4Len3",-11), help="VBF blikelihood debug"),
 ])
