...
#print "VH"
	...
	remainingPF = [x for x in event.pfCands if x.charge() != 0 and abs(x.eta()) < 2.5 and  x.pt() > 0.3 and x.pvAssociationQuality()>= x.CompatibilityDz and abs(x.dz()) < 0.2 and x.vertexRef().key()==0 and x not in used] 
