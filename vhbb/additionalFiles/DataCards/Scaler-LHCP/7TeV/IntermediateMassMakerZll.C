...
for(int i = 0; i < n; i++)
{
  ...
  if(IFILE.Contains ("Zee") && IFILE.Contains("Med") && IFILE.Contains("7TeV"))  oldFolder = "ZeeLoose_7TeV";
  if(IFILE.Contains ("Zmm") && IFILE.Contains("Med") && IFILE.Contains("7TeV"))  oldFolder = "ZmmLoose7TeV";
  if(IFILE.Contains ("Zee") && IFILE.Contains("Tight") && IFILE.Contains("7TeV"))  oldFolder = "ZeeTight_7TeV";
  if(IFILE.Contains ("Zmm") && IFILE.Contains("Tight") && IFILE.Contains("7TeV"))  oldFolder = "ZmmTight_7TeV";

  if(IFILE.Contains ("Zee") && IFILE.Contains("Med") && IFILE.Contains("8TeV"))  oldFolder = "ZeeLoose_8TeV";
  if(IFILE.Contains ("Zmm") && IFILE.Contains("Med") && IFILE.Contains("8TeV"))  oldFolder = "ZmmLoose_8TeV";
  if(IFILE.Contains ("Zee") && IFILE.Contains("Tight") && IFILE.Contains("8TeV"))  oldFolder = "ZeeTight_8TeV";
  if(IFILE.Contains ("Zmm") && IFILE.Contains("Tight") && IFILE.Contains("8TeV"))  oldFolder = "ZmmTight_8TeV";
