...
struct ZZ2l2nuSummary_t
{
  ...
  Float_t mn_nMatches[MAXPARTICLES],mn_validMuonHits[MAXPARTICLES];
  ...
  Float_t jn_beta[MAXPARTICLES],  jn_betaStar[MAXPARTICLES], jn_dRMean[MAXPARTICLES], jn_ptD[MAXPARTICLES], jn_ptRMS[MAXPARTICLES];
  ...
  Float_t ajn_beta[MAXPARTICLES],  ajn_betaStar[MAXPARTICLES], ajn_dRMean[MAXPARTICLES], ajn_ptD[MAXPARTICLES], ajn_ptRMS[MAXPARTICLES], ajn_idbits[MAXPARTICLES];
