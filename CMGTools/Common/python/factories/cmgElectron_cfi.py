...
cmgElectron = cms.EDFilter("ElectronPOProducer",
    ...
    cuts = cms.PSet(
       ...
       notEBEEGap = cms.string('!sourcePtr().isEBEEGap()'),
       chargeConsistent = cms.string('sourcePtr().isGsfCtfScPixChargeConsistent()'),
       noLostHits = cms.string(
           'sourcePtr().gsfTrack().trackerExpectedHitsInner().numberOfLostHits() == 0'),
       ...
       HyperTight1MCID = cicSuperTightID.clone(),
