...
process.source = cms.Source("PoolSource",
    ...
    #'file:/shome/wehrlilu/SecVtx/SVProd/rootfiles/00ABE731-9382-DD11-9605-001D09F28D4A.root',
    #'file:/shome/wehrlilu/SecVtx/SVProd/rootfiles/027E628C-9382-DD11-A912-001617DBD472.root'
...
process.prunedGenParticles = cms.EDProducer(
    ...
    'keep abs(pdgId)/100 == 5','keep abs(pdgId)/1000 == 5','keep abs(pdgId) == 5','keep status == 3','keep pt > 0.5'
    )
)
##############
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('twoBAllConeAllstatus.root'),
...
#ab22XsecondaryVertexTagInfos.trackSelection.maxDistToAxis = 99999.0
secondaryVertexTagInfos.vertexCuts.maxDeltaRToJetAxis = 1.0

##############
#Cone 0.8
process.secondaryVertexTagInfosC08 = secondaryVertexTagInfos.clone()
process.secondaryVertexTagInfosC08.trackSelection.jetDeltaRMax = cms.double(0.8)
#ab22Xprocess.secondaryVertexTagInfosC08.trackSelection.maxDistToAxis = cms.double(99999.0)
process.secondaryVertexTagInfosC08.vertexCuts.maxDeltaRToJetAxis = cms.double(1.0)

##############
#Cone 0.3
process.secondaryVertexTagInfosC03 = secondaryVertexTagInfos.clone()
#ab22Xprocess.secondaryVertexTagInfosC03.trackSelection.maxDistToAxis = cms.double(99999.0)
...
##############
#in 21X the following two parameters have to be changed, in 22X both are in sec.V.T.infos (see addSe.. in Analyzer)
process.impactParameterTagInfos.maximumDistanceToJetAxis = 9999.0
process.impactParameterTagInfos.maximumDecayLength = 9999.0
...
process.p = cms.Path(process.prunedGenParticles*process.SimSecVertices*process.BHadrons*process.offlineBeamSpot*process.ic5JetTracksAssociatorAtVertex*process.impactParameterTagInfos*secondaryVertexTagInfos*process.secondaryVertexTagInfosC08*process.secondaryVertexTagInfosC03)
