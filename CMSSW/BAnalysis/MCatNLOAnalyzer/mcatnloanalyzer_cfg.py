...
process.TFileService = cms.Service("TFileService",
                                  #fileName = cms.string("bbdist_mcatnlo_pthat30.root")
...
process.bbdistmcatnlo = cms.EDAnalyzer('MCatNLOAnalyzer',
				    ...
				    #ptcut on leading jet is 84 (hardcoded!!)
                                    minPt = cms.untracked.double(15),   #for b, not for LJ
                                    maxEta = cms.untracked.double(2.4), #for b, not for LJ
                                    minPThat = cms.untracked.double(0), #pthat is pt of hardest b quark (id 5) 
                                    maxPThat = cms.untracked.double(100000) #pthat is pt of hardest b quark (id 5)
)
