 ...
 if (channel!="data_obs")
{
  ...
  if((syst == "stat"))
  {
    ...
    { 
      nameUp  = channel + "_CMS_vhbb_stat" + channel + "_" + oldFolder.Data() + "Up";
      namen  = channel;
      nameDown  = channel + "_CMS_vhbb_stat" + channel + "_" + oldFolder.Data() + "Down";
    }
  ...
  if((syst == "ZJModel"))
  {
    ...
    if(IFILE.Contains("8TeV"))
    { 
      nameUp  = channel + "_CMS_vhbb_ZJModel_" + oldFolder.Data() + "Up";
      namen  = channel;
      nameDown  = channel + "_CMS_vhbb_ZJModel_" + oldFolder.Data() + "Down";
    }
...
void Process(TString fname, TString oldFolder, int toMass, int fromMass)
{
  ...
  oldFolder2.ReplaceAll("Low","High");
...
//  makeSystPlot(file, oldFolder, myWS, "ZjLF", "ZJModel",toMass, fromMass);
//  makeSystPlot(file, oldFolder, myWS, "ZjHF", "ZJModel",toMass, fromMass);


//  makeSystPlot(file, oldFolder2, myWS2, "ZjLF", "ZJModel",toMass, fromMass);
//  makeSystPlot(file, oldFolder2, myWS2, "ZjHF", "ZJModel",toMass, fromMass);
