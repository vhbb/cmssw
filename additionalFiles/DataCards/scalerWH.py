...
files=[
"vhbb_DC_BDT_M110_Wln_8TeV.txt",
"vhbb_DC_BDT_M115_Wln_8TeV.txt",
"vhbb_DC_BDT_M120_Wln_8TeV.txt",
"vhbb_DC_BDT_M125_Wln_8TeV.txt",
"vhbb_DC_BDT_M130_Wln_8TeV.txt",
"vhbb_DC_BDT_M135_Wln_8TeV.txt"
]
...
def Process(file, toMass, fromMass):
       ...
       os.system("sed -i 's/vhbb_WS_BDT_M110_WenLowPt_8TeV.root/vhbb_WS_BDT_M110_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
       os.system("sed -i 's/vhbb_WS_BDT_M115_WenLowPt_8TeV.root/vhbb_WS_BDT_M115_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
       os.system("sed -i 's/vhbb_WS_BDT_M120_WenLowPt_8TeV.root/vhbb_WS_BDT_M120_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
       os.system("sed -i 's/vhbb_WS_BDT_M125_WenLowPt_8TeV.root/vhbb_WS_BDT_M125_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
       os.system("sed -i 's/vhbb_WS_BDT_M130_WenLowPt_8TeV.root/vhbb_WS_BDT_M130_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
       os.system("sed -i 's/vhbb_WS_BDT_M135_WenLowPt_8TeV.root/vhbb_WS_BDT_M135_WenLowPt_%s.root/g' %s " % (mass[toMass],newcard))
