...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('twoB.root'),
...
#process.p = cms.Path(process.bfilter*process.printList*process.prunedGenParticles*process.SimSecVertices*process.BHadrons)
process.p = cms.Path(process.bfilter*process.prunedGenParticles*process.SimSecVertices*process.BHadrons)
