...
float CSVL_SFb(float x) {return 1.02658*((1.+(0.0195388*x))/(1.+(0.0209145*x))); }
...
float CSVM_SFb(float x) {return  0.6981*((1.+(0.414063*x))/(1.+(0.300155*x)));}
...
float CSVT_SFb(float x) {return   0.901615*((1.+(0.552628*x))/(1.+(0.547195*x))); }
