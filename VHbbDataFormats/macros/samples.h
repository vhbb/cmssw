...
// s.push_back(Sample(1000,"data","SingleMu_HBB_EDMNtupleV1_ProcV2_may_histos.root",0 , true,113));
 s.push_back(Sample(1000,"data","mm/SingleMu_HBB_EDMNtupleV1_ProcV2_prompt_histos.root",0 , true,600));
/* s.push_back(1000,"data","DoubleElectron_HBB_EDMNtupleV1_ProcV2_prompt_histos.root",1 , true )
 s.push_back(1000,"data","DoubleMu_HBB_EDMNtupleV1_ProcV2_prompt_histos.root", 1, true)
 s.push_back(1000,"data","METBTag_HBB_EDMNtupleV1_ProcV2_may_histos.root", 1, true)
 s.push_back(1000,"data","MET_HBB_EDMNtupleV1_ProcV2_prompt_histos.root", 1, true)
*/
  s.push_back(Sample(165,"TTbar","TTJets_TuneZ2_7TeV-madgraph-tauola_HBB_EDMNtupleV1_ProcV2_histos.root", 2 , false ));
...
//TOT: 18904365 b: 363441 c: 6264682 l: 12276242
 ...
 s.push_back(Sample(wxsec*b/t,"Wb","WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_HBB_EDMNtupleV1_ProcV2_histosB.root", 3, false ));
 s.push_back(Sample(wxsec*c/t,"Wc","WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_HBB_EDMNtupleV1_ProcV2_histosC.root", 7, false ));
 s.push_back(Sample(wxsec*l/t,"Wl","WJetsToLNu_TuneZ2_7TeV-madgraph-tauola_HBB_EDMNtupleV1_ProcV2_histosL.root", 8, false ));
...
int VVcolor=5;
 s.push_back(Sample(42.9,"VV","WW_TuneZ2_7TeV_pythia6_tauola_HBB_EDMNtupleV1_ProcV2_histos.root",VVcolor , false ));
 s.push_back(Sample(18.3,"VV","WZ_TuneZ2_7TeV_pythia6_tauola_HBB_EDMNtupleV1_ProcV2_histos.root",VVcolor , false ));
 s.push_back(Sample(5.9,"VV","ZZ_TuneZ2_7TeV_pythia6_tauola_HBB_EDMNtupleV1_ProcV2_histos.root",VVcolor , false ));
