...
def shiftJERfactor(JERShift, aeta):
        """Taken from run1 prescriptions, return JER factor as function of absolute eta, with parameters as in run1. JERShift can be 0, for nominal shift, or +/- when we want to propagate up and down uncertainty"""
