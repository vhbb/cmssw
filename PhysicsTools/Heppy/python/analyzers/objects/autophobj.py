...
tauType = NTupleObjectType("tau",  baseObjectTypes = [ particleType ], variables = [
    ...
    NTupleVariable("rawJetPt", lambda x : x.pfEssential().p4Jet_.pt(), help="transverse momentum of jet from which this tau was built, jet energy corrections not applied"),
    NTupleVariable("corrJetPt", lambda x : x.pfEssential().p4CorrJet_.pt(), help="transverse momentum of jet from which this tau was built, jet energy corrections applied"),
    NTupleVariable("rawJetEta", lambda x : x.pfEssential().p4Jet_.eta(), help="pseudo-rapidity of jet from which this tau was built"),
    NTupleVariable("rawJetPhi", lambda x : x.pfEssential().p4Jet_.phi(), help="azimuthal angle of jet from which this tau was built"),    
